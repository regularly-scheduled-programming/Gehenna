...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAkLuminInitializationSettings_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "InitializationSettings/AkLuminInitializationSettings.h" },
		{ "ModuleRelativePath", "Classes/InitializationSettings/AkLuminInitializationSettings.h" },
	};
#endif
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAkLuminInitializationSettings_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UAkLuminInitializationSettings_Statics::PropPointers),
		0,
		0x001000A6u,
		METADATA_PARAMS(Z_Construct_UClass_UAkLuminInitializationSettings_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAkLuminInitializationSettings_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAkLuminInitializationSettings, 2708453916);
