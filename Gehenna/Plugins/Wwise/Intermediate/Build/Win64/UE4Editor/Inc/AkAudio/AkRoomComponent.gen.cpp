...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAkRoomComponent_Statics::NewProp_bEnable_MetaData[] = {
		{ "Category", "Toggle" },
		{ "Comment", "/** Enable room occlusion feature, additional properties are available in the Room category. */" },
		{ "DisplayName", "Enable Room" },
		{ "ModuleRelativePath", "Classes/AkRoomComponent.h" },
		{ "ToolTip", "Enable room occlusion feature, additional properties are available in the Room category." },
	};
#endif
	...
	IMPLEMENT_CLASS(UAkRoomComponent, 4135054382);
